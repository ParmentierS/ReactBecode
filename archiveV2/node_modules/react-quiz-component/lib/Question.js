...
/*#__PURE__*/
function (_Component) {
  _inherits(QuizCore, _Component);

  function QuizCore(props) {
    var _this;

    _classCallCheck(this, QuizCore);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(QuizCore).call(this, props));
  ...
  _createClass(QuizCore, [{
    ...
    value: function render() {
      ...
      }, this.renderMessageforIncorrectAnswer(question)), correctAnswer && showInstantFeedback && _react.default.createElement("div", {
        className: "alert correct"
      }, this.renderMessageforCorrectAnswer(question), this.renderExplanation(question, false))), _react.default.createElement("div", null, appLocale.question, " ", currentQuestionIndex + 1, ":"), _react.default.createElement("h3", {
      ...
      }), showNextQuestionButton && _react.default.createElement("div", null, _react.default.createElement("button", {
        onClick: function onClick() {
